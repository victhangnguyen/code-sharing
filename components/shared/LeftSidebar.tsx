...
const LeftSidebar = () => {
  ...
  return (
    <section
      className="background-light900_dark200 light-border custom-scrollbar sticky left-0 top-0 flex h-screen flex-col
    ...
    >
      ...
      <SignedOut>
        <div className="flex flex-col gap-3">
          ...
          <Link href="/sign-up">
            <Button className="small-medium light-border-2 btn-tertiary text-dark400_light900 min-h-[41px] w-full rounded-lg px-4 py-3 shadow-none"></Button>
          </Link>
        </div>
      </SignedOut>
    </section>
